...
const INTERRUPT_CALLS: StaticArray<i8> = new StaticArray<i8>(10);
INTERRUPT_CALLS[0] = IFLAG_VBLANK;
INTERRUPT_CALLS[1] = 0x0040;
INTERRUPT_CALLS[2] = IFLAG_LCDC;
INTERRUPT_CALLS[3] = 0x0048;
INTERRUPT_CALLS[4] = IFLAG_TIMER;
INTERRUPT_CALLS[5] = 0x0050;
INTERRUPT_CALLS[6] = IFLAG_SERIAL;
INTERRUPT_CALLS[7] = 0x0058;
INTERRUPT_CALLS[8] = IFLAG_JOYPAD;
INTERRUPT_CALLS[9] = 0x0060;
